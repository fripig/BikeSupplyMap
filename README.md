...
- 開啟時就畫出 21 條河濱自行車道（藍色）與可騎自行車過河的橋梁路線（紫色，19 條來自 OSM 路線，另加補充清單裡的重陽橋），點橋梁路線會顯示名稱。
- 河濱與橋梁路線 200 m 內的自動販賣機（約 70 台）開啟時就以青綠色圓點標出，關掉店家類型的「自動販賣機」會一起隱藏；點圓點會顯示名稱（沒有名稱時顯示「自動販賣機」）與販售種類（飲料、飲水、咖啡、食物）。
