...
5. **Verify Completeness**
   ...
   **Spec Coverage**:
   With delta specs in `docs/spectra/changes/<name>/specs/`, fetch `spectra instructions --skill verify-spec-coverage --agent claude` once and run its Spec Coverage checks. Without delta specs, skip the fetch.
